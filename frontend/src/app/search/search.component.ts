...
export class SearchComponent {
    ...
    requestBackend() {
        ...
        backend_url = backend_url + "/search?"
    ...
    displayDetail(j: any) {
        ...
        this.detailContent.statusColor = {
            'btn-success': this.detailContent.TicketStatus === 'onsale',
    ...
    requestBackendToAutoComplete(keyword: String) {
        ...
        let backendUrl = backend_url + "/autocomplete?"
